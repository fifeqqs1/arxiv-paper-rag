...
- Keep citations readable: cite once per paragraph or bullet, not after every sentence or clause
- If the answer is about a single paper, cite it once near the start and avoid repeating the same citation after every point
