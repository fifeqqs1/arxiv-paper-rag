...
class ArxivClient:
    ...
    @property
    def search_query_override(self) -> str:
        return self._settings.search_query_override
    ...
    async def fetch_papers(
        ...
        # Build search query
        search_query = self.search_query_override.strip() or f"cat:{self.search_category}"
        ...
        try:
            logger.info(f"Fetching {max_results} papers from arXiv using query: {search_query}")
