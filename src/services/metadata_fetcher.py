...
class MetadataFetcher:
    ...
    async def fetch_and_process_papers(
        ...
        :param search_query: Optional custom arXiv query. If provided, date/category defaults are bypassed.
        ...
        try:
            ...
            results["fetched_arxiv_ids"] = [paper.arxiv_id for paper in papers]
