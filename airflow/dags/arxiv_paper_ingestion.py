...
from arxiv_ingestion.cleanup import prune_local_papers
...
retention_task = PythonOperator(
    task_id="prune_local_papers",
    python_callable=prune_local_papers,
    dag=dag,
)
...
# Task dependencies
# Simplified pipeline: setup -> fetch -> hybrid index -> report -> retention -> cleanup
setup_task >> fetch_task >> index_hybrid_task >> report_task >> retention_task >> cleanup_task
