...
def create_gradio_interface():
    ...
    with gr.Blocks(
        title="arXiv Paper RAG - Chat",
        theme=gr.themes.Soft(),
    ) as interface:
        gr.Markdown(
            """
            # 🔬 arXiv Paper RAG - Chat
        ...
        gr.Markdown(
            ...
            **Note**: Make sure the RAG API server is running at `http://localhost:8001` before using this interface.
...
def main():
    ...
    print("🚀 Starting arXiv Paper RAG Gradio Interface...")
